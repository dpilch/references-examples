...
@ModelConfig(pluralName = "RelatedOnes", type = Model.Type.USER, version = 1)
...
public final class RelatedOne implements Model {
  ...
  public static class RelatedOneIdentifier extends ModelIdentifier<RelatedOne> {
    private static final long serialVersionUID = 1L;
    public RelatedOneIdentifier(String id) {
      super(id);
    }
  }
